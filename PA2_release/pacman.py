...
def runGames( layout, pacman, ghosts, display, numGames, record, numTraining = 0, catchExceptions=False, timeout=30 ):
  ...
  for i in range( numGames ):
    ...
    if not beQuiet: 
      games.append(game)
      # if hasattr(pacman, 'minimaxValue'):
      #   minimaxValues.append(pacman.minimaxValue)
      # else:
      #   minimaxValues.append(None)
  ...
  if (numGames-numTraining) > 0:
    ...
    # print(('Minimax Values:', ', '.join([str(val) for val in minimaxValues])))
